...
class DatabaseHelper {
  ...
  Future _onCreate(Database db, int version) async {
    await db.execute("CREATE TABLE ${BetTable.name} (${BetTable.columnId} INTEGER PRIMARY KEY"
    ...
    await db.execute("CREATE TABLE ${BalanceTable.name} (${BalanceTable.columnId} INTEGER PRIMARY KEY"
